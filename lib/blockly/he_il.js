...
Blockly.Msg.COLLAPSE_ALL = "הקטן בלוקים";
Blockly.Msg.COLLAPSE_BLOCK = "הקטן בלוק";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "תעשה כמה חישובים מספר פעמים.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "חזור כש";
...
Blockly.Msg.EXPAND_ALL = "הרבחב בלוקים";
Blockly.Msg.EXPAND_BLOCK = "הרחב בלוקים";
Blockly.Msg.EXTERNAL_INPUTS = "קלט חיצוני";
Blockly.Msg.HELP = "עזרה";
Blockly.Msg.INLINE_INPUTS = "קלט פנימי";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_LTE = "תחזיר אמת (true) אם הקלט הראשון הוא קטן יותר או שווה לקלט השני.";
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_NEQ = "תחזיר אמת (true) אם שני הקלטים אינם שווים זה לזה.";
