...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "增加、删除或者调整板块的顺序来重新配置“假设”板块。";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "如果值为真，执行第一部分的语句。否则，执行第二部分的语句。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "如果第一个值为真，执行第一部分的语句。否则，如果第二个值为真，执行第二部分的语句。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "如果第一个值为真，执行第一部分的语句。否则，如果第二个值为真，执行第二部分的语句。如果没有一个值为真，执行最后一部分的语句。";
