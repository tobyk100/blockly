...
Blockly.Xml.workspaceToDom = function(workspace) {
  ...
  var xml = Blockly.ieVersion() ? document.createElementNS(null, "xml") : document.createElement("xml");
...
Blockly.setAttributeNS = function(element, ns, name, value) {
  Blockly.ieVersion() == 8 ? element.setAttribute(name, value) : element.setAttributeNS(ns, name, value)
};
...
Blockly.inject = function(container, options) {
  ...
  var svg = Blockly.createSvgElement("svg", {"xmlns":"http://www.w3.org/2000/svg", "xmlns:html":"http://www.w3.org/1999/xhtml", "xmlns:xlink":"http://www.w3.org/1999/xlink", "version":"1.1", "id":"blocklySvg", "class":"blocklySvg"}, null);
