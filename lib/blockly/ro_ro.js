...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Sari peste restul aceastei bucle, şi continuă cu următoarea iterație.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Pentru fiecare element într-o listă, setaţi variabila '%1' ca valoarea elementului, şi apoi faceţi unele declaraţii.";
...
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "Cu variablia %1 ia o valoare din numărul început la numărul final, numără în intervalul specificat, și fă blocurile specificate.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Adăugaţi o condiţie in blocul dacă.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Adaugă o stare finală, cuprinde toată condiția din blocul dacă.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Dacă prima valoare este adevărată, atunci fă primul bloc de declaraţii.  Altfel, dacă a doua valoare este adevărată, fă al doilea bloc de declaraţii.  În cazul în care niciuna dintre valori nu este adevărată, fă ultimul bloc de declaraţii.";
...
Blockly.Msg.DISABLE_BLOCK = "Dezactivaţi blocul";
...
Blockly.Msg.LISTS_INDEX_OF_TOOLTIP = "Returnează indexul de la prima\/ultima apariție a elementului din listă. Returnează 0 daca textul nu este găsit.";
