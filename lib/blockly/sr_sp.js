...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "Додај, избриши, или преуреди делове како бих реорганизовали овај блок листи.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END = "Враћа ставку на одређену позицију на листи.#1 је последнја ставка.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START = "Враћа ставку на одређену позицију на листи.#1 је прва ставка.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_LAST = "Враћа последнју ставку са листе.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM = "Врађа ставку из листе слућајним одабитом.";
