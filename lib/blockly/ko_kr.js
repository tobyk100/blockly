...
Blockly.Msg.ADD_COMMENT = "주석을 추가하세요";
Blockly.Msg.CHANGE_VALUE_TITLE = "값을 변경하세요:";
Blockly.Msg.COLLAPSE_ALL = "블럭들을 축약하세요";
Blockly.Msg.COLLAPSE_BLOCK = "블럭을 축약하세요";
Blockly.Msg.COLOUR_BLEND_COLOUR1 = "색갈 1";
Blockly.Msg.COLOUR_BLEND_COLOUR2 = "색갈 2";
Blockly.Msg.COLOUR_BLEND_HELPURL = "http:\/\/meyerweb.com\/eric\/tools\/color-blend\/";
Blockly.Msg.COLOUR_BLEND_RATIO = "비율";
Blockly.Msg.COLOUR_BLEND_TITLE = "혼합하세요";
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "두 색갈을 주어진 비율 (0.0-1.0)으로 혼합하세요.";
Blockly.Msg.COLOUR_PICKER_HELPURL = "http:\/\/en.wikipedia.org\/wiki\/Color";
Blockly.Msg.COLOUR_PICKER_TOOLTIP = "파레트에서 색갈을 선택하세요.";
Blockly.Msg.COLOUR_RANDOM_HELPURL = "http:\/\/randomcolour.com";
Blockly.Msg.COLOUR_RANDOM_TITLE = "임의의 색갈";
Blockly.Msg.COLOUR_RANDOM_TOOLTIP = "색갈을 임으로 선택하세요.";
Blockly.Msg.COLOUR_RGB_BLUE = "청색";
Blockly.Msg.COLOUR_RGB_GREEN = "초록";
Blockly.Msg.COLOUR_RGB_HELPURL = "http:\/\/www.december.com\/html\/spec\/colorper.html";
Blockly.Msg.COLOUR_RGB_RED = "적색";
Blockly.Msg.COLOUR_RGB_TITLE = "색갈로";
Blockly.Msg.COLOUR_RGB_TOOLTIP = "지정된 양의 적색, 초록, 청색으로 색갈을 생성하세요. 모든 값은 0에세 100사이 입니다.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Loops#Loop_Termination_Blocks";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "루프 빠져 나오기";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "루프의 다음 반복 계속 수행";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "포함된 루프에서 빠져 나오기.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "루프의 나머지 부분을 건너뛰고, 다음 반복을 계속하세요.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "경고:이 블럭은 루프안에서 사용됩니다.";
Blockly.Msg.CONTROLS_FOREACH_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Loops#for_each for each block";
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST = "리스트 요소에 대하여";
Blockly.Msg.CONTROLS_FOREACH_INPUT_INLIST_TAIL = "";
Blockly.Msg.CONTROLS_FOREACH_INPUT_ITEM = "각 요소에 대하여";
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "리스트안의 각요소에 대하여, 변수 '%1'을 세트하고, 다음 문장을 수행하시오.";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Loops#count_with";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "%1에서부터 %2까지 %3 간격으로";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "세어 보기";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "변수 %1을 시작 번호에서 끝 번호로, 지정도 간격 만큼씩 변경하면서, 지정된 블럭들을 수행하시오.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "if 블럭에 조건을 추가하시오.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "if 블럭에 최종 catch-all 조건을 추가하시오.";
Blockly.Msg.CONTROLS_IF_HELPURL = "http:\/\/code.google.com\/p\/blockly\/wiki\/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "이 if 블럭을 재구성하기 위해서 섹션을 추가, 삭제 또는 재배열하시오.";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "else";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "else if";
Blockly.Msg.CONTROLS_IF_MSG_IF = "if";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "만약 값이 참이면, 다음 문장을 실행하시오.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "만약 값이 참이면 이 문장의 첫 불럭을 실행하고. 그렇치 않으면 문장의 두번째 블럭을 실행하시오.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "만약 첫번째 값이 참이면 첫번째 블럭을 실행하고. 그렇지 않은 경우, 두번째 값이 참이면 문장의 두번째 블럭을 실행하시오.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "만약 첫번째 값이 참이면 첫번째 블럭을 실행하고. 그렇지 않은 경우, 두번째 값이 참이면 문장의 두번째 블럭을 실행하시오. 만약 어느 값도 참이 아니면 문장의 마지막 블럭을 실행하시오.";
Blockly.Msg.CONTROLS_REPEAT_HELPURL = "http:\/\/en.wikipedia.org\/wiki\/For_loop";
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "do";
Blockly.Msg.CONTROLS_REPEAT_TITLE = "%1 번 반복하시오";
Blockly.Msg.CONTROLS_REPEAT_TITLE_REPEAT = "반북";
...
Blockly.Msg.LISTS_GET_SUBLIST_END_FROM_END = "끝에서 #로";
Blockly.Msg.LISTS_GET_SUBLIST_END_FROM_START = "#로";
