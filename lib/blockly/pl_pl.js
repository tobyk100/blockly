...
Blockly.Msg.COLOUR_BLEND_COLOUR1 = "kolor1";
Blockly.Msg.COLOUR_BLEND_COLOUR2 = "kolor2";
Blockly.Msg.COLOUR_BLEND_HELPURL = "http:\/\/meyerweb.com\/eric\/tools\/color-blend\/";
Blockly.Msg.COLOUR_BLEND_RATIO = "proporcja";
Blockly.Msg.COLOUR_BLEND_TITLE = "mieszanka";
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Miesza dwa kolory w danych proporcjach (0.0 - 1.0).";
...
Blockly.Msg.CONTROLS_FOREACH_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Loops#for _each dla każdego bloku";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Jeśli wartość jest prawdziwa,  wykonaj kilka instrukcji.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Jeśli wartość jest prawdziwa, wykonaj pierwszy blok instrukcji.  W przeciwnym razie wykonaj drugi blok instrukcji.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Jeśli wartość jest prawdziwa, wykonaj pierwszy blok instrukcji.  W przeciwnym razie, jeśli druga wartość jest prawdziwa, wykonaj drugi blok instrukcji.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "powtarzaj podczas";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_START = "Usuwa element z określonej pozycji na liście. #1 to pierwszt element.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST = "Usuwa ostatni element z listy.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM = "Usuwa element losowo z listy.";
Blockly.Msg.LISTS_GET_SUBLIST_END_FROM_END = "# od końca";
...
Blockly.Msg.MATH_TRIG_ACOS = "arcus cosinus";
Blockly.Msg.MATH_TRIG_ASIN = "arcus sinus";
Blockly.Msg.MATH_TRIG_ATAN = "arcus tangens";
...
Blockly.Msg.PROCEDURES_DEF_DUPLICATE_WARNING = "Ostrzeżenie: Ta funkcja ma zduplikowane parametry.";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "zmień na Dużą Literę";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "zmień na DUŻE LITERY";
...
Blockly.Msg.TEXT_CHARAT_TOOLTIP = "Zwraca daną literę na określonej pozycji.";
Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TOOLTIP = "Dodaj element do tekstu.";
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = "połącz";
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP = "Dodaj, usuń lub zmień kolejność sekcji, żeby edytować ustawienia tego bloku tekstu.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "pobierz podsłowo z pierwszej litery";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "pobierz podsłowo z litery # od końca";
...
Blockly.Msg.TEXT_ISEMPTY_TITLE = "%1 jest puste";
...
Blockly.Msg.TEXT_TEXT_TOOLTIP = "Znak, wyraz albo linia tekstu.";
