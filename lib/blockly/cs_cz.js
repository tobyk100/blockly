...
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "Spojuje dvě barvy dohromady se v daném poměru (0.0 - 1.0).";
...
Blockly.Msg.COLOUR_RANDOM_TOOLTIP = "Zvol jakoukoliv barvu.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "Prolomit smyčku";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "Varování: Tento blok může být pouze uvnitř smyčky.";
...
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Je-li první hodnota \"true\"(kladná), udělej první blok příkazů.  V opačném případě je-li druhá hodnota \"true\"(kladná), udělej druhý blok příkazů.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "If the first value is true, then do the first block of statements.  Otherwise, if the second value is true, do the second block of statements.  If none of the values are true, do the last block of statements.";
Blockly.Msg.CONTROLS_REPEAT_HELPURL = "http:\/\/en.wikipedia.org\/wiki\/For_loop";
Blockly.Msg.CONTROLS_REPEAT_INPUT_DO = "provést";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Když je hodnota nepravdivá, vypiš oznámení.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "While a value is true, then do some statements.";
Blockly.Msg.DELETE_BLOCK = "Odstranit blok";
Blockly.Msg.DELETE_X_BLOCKS = "Odstranit %1 bloků";
Blockly.Msg.DISABLE_BLOCK = "Neaktivní blok";
Blockly.Msg.DUPLICATE_BLOCK = "Kopírovat";
Blockly.Msg.ENABLE_BLOCK = "Aktivní blok";
...
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "vytvořiř seznam s";
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "Přidat položku na seznam.";
...
Blockly.Msg.LISTS_GET_INDEX_RANDOM = "náhodná";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END = "Vrátí položky na určené pozici v seznamu.  #1 je poslední položkou.";
...
Blockly.Msg.LISTS_GET_SUBLIST_END_LAST = "do posledního";
...
Blockly.Msg.LOGIC_BOOLEAN_TOOLTIP = "Vrací hodntu pravda nebo nepravda.";
...
Blockly.Msg.LOGIC_NULL = "nulová hodnota";
...
Blockly.Msg.LOGIC_TERNARY_IF_FALSE = "pokud je hodnota nepravdivá";
Blockly.Msg.LOGIC_TERNARY_IF_TRUE = "pokud je hodnota pravdivá";
...
Blockly.Msg.MATH_IS_NEGATIVE = "je záporný";
Blockly.Msg.MATH_IS_ODD = "je lichý";
Blockly.Msg.MATH_IS_POSITIVE = "je kladný";
