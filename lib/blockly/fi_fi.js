...
Blockly.Msg.COLLAPSE_ALL = "Romahduta palikat";
Blockly.Msg.COLLAPSE_BLOCK = "Romahduta palikka";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "murtaudu ulos silmukasta";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "jatka silmukan seuraavaan iterointiin";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Murtaudu ulos sisältyvästä silmukasta.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Ohita loppu tästä silmukasta ja siirry seuraavaan iteraatioon.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "Varoitus: Tätä palikkaa voi käyttää vain silmukan sisällä.";
...
Blockly.Msg.CONTROLS_FOREACH_INPUT_ITEM = "jokaiseen kohteeseen";
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Aseta muuttuja '%1' jokaiseen kohteeseen listalla, ja tee sen jälkeen muutamia lauseita.";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Loops#count_with";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "%1:stä %2:een ja siitä %3:een";
