...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "terminar la iteración";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "continuar con la siguiente iteración";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Terminar el bucle.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Salta el resto de esta iteración, y continua con la siguiente.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "repita hasta";
...
Blockly.Msg.EXPAND_ALL = "Expander bloques";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "Inserta aleatoria mente el elemento en una lista.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Checa la condición en \"prueba\". Si la condición es verdadera, devuelve el valor \"si es verdadero\"; de lo contrario, devuelver el valor \"si es falso\".";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "Devolver una fracción aleatoria entre 0.0  y 1.0.";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "Devolver un entero aleatorio entre los dos límites especificados.";
...
Blockly.Msg.MATH_SINGLE_TOOLTIP_EXP = "Devuelve euler a la potencia de un número.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "hace algo";
...
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = "Destaca la definición de la función";
...
Blockly.Msg.TEXT_APPEND_TOOLTIP = "Añadir algun texto a la variable '%1'.";
...
Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TOOLTIP = "Agrega un elemento al texto.";
Blockly.Msg.TEXT_CREATE_JOIN_TITLE_JOIN = "unir";
Blockly.Msg.TEXT_CREATE_JOIN_TOOLTIP = "Agrega, elimina o re-ordena las secciones para re-configurar este bloque de texto.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "obtiene una  subcadena de la primera letra";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "obtener subcadena de la letra # del final";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "obtiene una subcadena a partir de la letra con el indice #";
...
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT = "Solicitar al usuario por algún texto.";
