...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_LAST = "Suprimeix l'últim element en una llista.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_RANDOM = "Elimina un element aleatori d'una llista.";
Blockly.Msg.LISTS_GET_SUBLIST_END_FROM_END = "fins a # des del final";
Blockly.Msg.LISTS_GET_SUBLIST_END_FROM_START = "fins a #";
Blockly.Msg.LISTS_GET_SUBLIST_END_LAST = "fins últim";
Blockly.Msg.LISTS_GET_SUBLIST_HELPURL = "https:\/\/code.google.com\/p\/bloc\/wiki\/Lists#Agafar_una_subllista";
Blockly.Msg.LISTS_GET_SUBLIST_START_FIRST = "agafa subllista des del primer";
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_END = "agafa subllista des de # des del final";
...
Blockly.Msg.LISTS_INDEX_OF_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Lists#Agafar_Elements_d'una_Llista";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FIRST = "Insereix l'element a l'inici d'una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END = "Insereix l'element a la posició especificada en una llista.  #1 és l'últim element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START = "Insereix l'element a la posició especificada en una llista.  #1 és el primer element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST = "Afegir l'element al final d'una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "Insereix l'element a l'atzar en una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FIRST = "Estableix el primer element en una llista.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_END = "Estableix l'element a la posició especificada en una llista. #1 és l'últim element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_START = "Estableix l'element a la posició especificada en una llista. #1 és el primer element.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_LAST = "Estableix l'últim element en una llista.";
...
Blockly.Msg.MATH_CHANGE_TOOLTIP = "Afegir un nombre a la variable '%1'.";
...
Blockly.Msg.MATH_IS_PRIME = "és nombre primer";
...
Blockly.Msg.MATH_ONLIST_OPERATOR_MAX = "max de la llista";
Blockly.Msg.MATH_ONLIST_OPERATOR_MEDIAN = "mediana de la llista";
Blockly.Msg.MATH_ONLIST_OPERATOR_MIN = "min de la llista";
...
Blockly.Msg.PROCEDURES_CALLRETURN_TOOLTIP = "Executar la funció '%1' definida per l'usuari i utilitzar les dades de sortida.";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_PROCEDURE = "fes algo";
...
Blockly.Msg.PROCEDURES_DEFRETURN_TOOLTIP = "Crea una funció amb dades de sortida.";
...
Blockly.Msg.PROCEDURES_IFRETURN_WARNING = "Advertència: Aquest bloc pot ser utilitzat només dins una definició de funció.";
Blockly.Msg.PROCEDURES_MUTATORARG_TITLE = "nom de dada d'entrada:";
Blockly.Msg.PROCEDURES_MUTATORCONTAINER_TITLE = "dades d'entrada";
Blockly.Msg.REMOVE_COMMENT = "Eliminar comentari";
Blockly.Msg.RENAME_VARIABLE = "Reanomenar variable...";
Blockly.Msg.RENAME_VARIABLE_TITLE = "Reanomenar totes les variables '%1' a:";
...
Blockly.Msg.TEXT_APPEND_TOOLTIP = "Afegir text a variable '%1'.";
Blockly.Msg.TEXT_CHANGECASE_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Text#Ajustant_majuscules_i_minuscules";
...
Blockly.Msg.TEXT_CHARAT_FIRST = "agafa primera lletra";
Blockly.Msg.TEXT_CHARAT_FROM_END = "agafa lletra # des de final";
Blockly.Msg.TEXT_CHARAT_FROM_START = "agafa lletra #";
Blockly.Msg.TEXT_CHARAT_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Text#Extraient_text";
Blockly.Msg.TEXT_CHARAT_INPUT_INTEXT = "en el text";
Blockly.Msg.TEXT_CHARAT_LAST = "aconsegueix última lletra";
Blockly.Msg.TEXT_CHARAT_RANDOM = "aconsegueix lletra a l'atzar";
Blockly.Msg.TEXT_CHARAT_TAIL = "";
Blockly.Msg.TEXT_CHARAT_TOOLTIP = "Retorna la lletra a la posició especificada.";
Blockly.Msg.TEXT_CREATE_JOIN_ITEM_TOOLTIP = "Afegir un element al text.";
...
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END = "a lletra # des de final";
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_START = "a lletra #";
Blockly.Msg.TEXT_GET_SUBSTRING_END_LAST = "a última lletra";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "agafa subtext des de primera lletra";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "agafa subtext des de lletra # des de final";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "agafa subtext des de lletra #";
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = "";
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP = "Returns a specified portion of the text.";
Blockly.Msg.TEXT_INDEXOF_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Text#Trobant_text";
Blockly.Msg.TEXT_INDEXOF_INPUT_INTEXT = "en el text";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST = "trobar primera ocurrència del text";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST = "troba última ocurrència del text";
Blockly.Msg.TEXT_INDEXOF_TAIL = "";
Blockly.Msg.TEXT_INDEXOF_TOOLTIP = "Retorna  l'index de la primera\/última ocurrència del primer text en el segon text. Retorna 0 si text no es troba.";
...
Blockly.Msg.TEXT_ISEMPTY_TOOLTIP = "Retorna cert si el text proveït és buit.";
...
Blockly.Msg.TEXT_JOIN_TOOLTIP = "Crea un tros de text unint qualsevol nombre d'elements.";
...
Blockly.Msg.VARIABLES_SET_CREATE_GET = "Crear 'aconseguir %1'";
