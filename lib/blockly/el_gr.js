...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "Προσθήκη, αφαίρεση, ή αναδιάταξη ενοτήτων για την αναμόρφωση αυτού του πλακιδίου λίστας";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START = "Αφαιρεί και επιστρέφει το στοιχείο στην καθορισμένη θέση σε μια λίστα.  #1 είναι το τελευταίο στοιχείο.";
...
Blockly.Msg.MATH_IS_TOOLTIP = "Ελέγχει αν ένας αριθμός είναι μονός, ζυγός, πρώτος, ακέραιος, θετικός, αρνητικός, ή αν διαιρείται από έναν ορισμένο αριθμό.  Επιστρέφει 'ΑΛΗΘΕΣ ή 'ΨΕΥΔΕΣ'.";
