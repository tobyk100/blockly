...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_HELPURL = "Μπλοκ Τερματισμού Βρόγχων.\n\nΟι περισσότεροι βρόγχοι εκτελούνται  μέχρι να ικανοποιηθεί η συνθήκη τερματισμού τους, (στην περίπτωση των μπλοκ  \"ΕΠΑΝΑΛΗΨΗ' repeat blocks) ή μέχρι η μεταβλητή επανάληψης να πάρει όλες τις τιμές που έχουν οριστεί (στην περίπτωση  των βρόγχων  'ΜΕΤΡΗΣΕ ΜΕΧΡΙ\" -  count with και \"ΓΙΑ ΚΑΘΕ \"-  for each). Δύο σπανίως χρησιμοποιούμενα αλλά καμιά φορά χρήσιμα μπλοκ  παρέχουν πρόσθετους τρόπους ελέγχου της συμπεριφοράς των βρόγχων.\nΠαρόλο που τα παρακάτω παραδείγματα είναι για τους βρόγχους \"ΓΙΑ ΚΑΘΕ\", μπορούν να χρησιμοποιηθούν για κάθε τύπο βρόγχου.  \n \nΣΥΝΕΧΙΣΕ ΜΕ ΤΗΝ ΕΠΟΜΕΝΗ ΕΠΑΝΑΛΗΨΗ\nΤο μπλοκ \"ΣΥΝΕΧΙΣΕ ΜΕ ΤΗΝ ΕΠΟΜΕΝΗ ΕΠΑΝΑΛΗΨΗ' (το οποίο καλείται \"ΣΥΝΕΧΙΣΕ\" - CONTINUE στις περισσότερες γλώσσες προγραμματισμού) παραλείπει όλο το  υπόλοιπο κομμάτι του κώδικα του μπλοκ και ξεκινά την επόμενη επανάληψη (pass) του βρόγχου.\n\nΤο παρακάτω πρόγραμμα  στην πρώτη επανάληψη του βρόγχου τυπώνει \"alpha\". Στη  δεύτερη επανάληψη εκτελείται το μπλοκ  \"ΣΥΝΕΧΙΣΕ ΜΕ ΤΗΝ ΕΠΟΜΕΝΗ ΕΠΑΝΑΛΗΨΗ\" και παραλείπει την εκτύπωση του \"beta\". στην τρίτη επανάληψη τυπώνεται το '\"gamma\"\n\nΕΞΟΔΟΣ ΑΠΟ ΤΟ ΒΡΟΓΧΟ\nΤο μπλοκ \"ΕΞΟΔΟΣ ΑΠΟ ΤΟ ΒΡΟΓΧΟ\" παρέχει ένα τρόπο πρόωρης εξόδου από τον βρόγχο. Το παρακάτω πρόγραμμα στην πρώτη επανάληψη τυπώνει \"alpha\" και μετά \"βγαίνει\" από τον βρόγχο όταν στη δεύτερη επανάληψη η μεταβλητή επανάληψης (loop variable) είναι ίση με το \"beta\". Η επανάληψη δεν φτάνει ποτέ στο τρίτο αντικείμενο της λίστας.  \n";
