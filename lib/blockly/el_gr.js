...
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "Πρόσθεσε, αφαίρεσε ή αναδιάταξε τμήματα για να διαμορφώσεις ξανά αυτή τη λίστα πλακιδίων.";
...
Blockly.Msg.LOGIC_COMPARE_TOOLTIP_EQ = "Επίστρεψε αληθής αν οι δύο είσοδοι είναι ίσες μεταξύ τους.";
...
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_AND = "Επιστρέφει αλήθεια αν και οι δύο είσοδοι είναι αλήθεια.";
Blockly.Msg.LOGIC_OPERATION_TOOLTIP_OR = "Επιστρέφει αλήθεια αν τουλάχιστον μία από τις εισόδους είναι αληθής.";
...
Blockly.Msg.MATH_CONSTRAIN_TITLE = "περιορίστε %1 χαμηλή %2 υψηλή %3";
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP = "Περιορίστε έναν αριθμό μεταξύ των προβλεπόμενων ορίων (συμπεριλαμβανομένων)";
...
Blockly.Msg.MATH_IS_TOOLTIP = "Ελέγχει αν ένας αριθμός είναι μονός, ζυγός, πρώτος, ακέραιος, φυσικός, θετικός, αρνητικός, ή αν διαιρείται από έναν συγκεκριμένο αριθμό.  Επιστρέφει 'ΑΛΗΘΗΣ ή 'ΨΕΥΔΗΣ'.";
...
Blockly.Msg.MATH_RANDOM_FLOAT_TOOLTIP = "Επιστρέφει μια τυχαία τιμή μεταξύ 0,0 (κλειστό) και 1.0 (ανοικτό).";
...
Blockly.Msg.MATH_RANDOM_INT_TOOLTIP = "Επιστρέφει ένα τυχαίο ακέραιο μεταξύ των δύο καθορισμένων ορίων, συμπεριλαμβανομένων και των ακραίων τιμών.";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Αν μια τιμή είναι true ''ΑΛΗΘΗΣ\", τότε επίστρεψε μια δεύτερη τιμή.";
