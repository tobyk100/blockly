...
Blockly.Msg.COLOUR_RGB_TITLE = "colore com";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "Faz uma quebra na rotina";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "continua com a próxima iteração na proxima rotina";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "Sai da rotina corrente";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "Ignora o resta rotina, e continua na rotina seguinte.";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "Atenção: Este bloco só pode ser usado dentro de uma rotina.";
Blockly.Msg.CONTROLS_FOREACH_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Loops#for_each para cada bloco";
...
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "de %1 ate %2 de %3 em %3";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Acrescente, remova ou reordene secções para reconfigurar este bloco de.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_END = "Remove o item na posição especificada em uma lista.  #1 é o ultimo item.";
...
Blockly.Msg.LISTS_GET_SUBLIST_END_LAST = "até ao último";
...
Blockly.Msg.LISTS_REPEAT_TOOLTIP = "Cria uma lista consistida por um dado valor repetido o número de vezes especificado.";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START = "Insere o item numa posição especificada em uma lista.  #1 é o primeiro item.";
