...
Blockly.Msg.COLOUR_BLEND_COLOUR1 = "色彩1";
Blockly.Msg.COLOUR_BLEND_COLOUR2 = "色彩2";
Blockly.Msg.COLOUR_BLEND_HELPURL = "http:\/\/meyerweb.com\/eric\/tools\/color-blend\/";
Blockly.Msg.COLOUR_BLEND_RATIO = "比例";
Blockly.Msg.COLOUR_BLEND_TITLE = "混合";
Blockly.Msg.COLOUR_BLEND_TOOLTIP = "將兩種顏色依照比例(0.0 - 1.0)混合";
...
Blockly.Msg.COLOUR_RGB_TITLE = "上...色";
Blockly.Msg.COLOUR_RGB_TOOLTIP = "根據給定的三原色紅、綠、藍，調出指定的顏色。所有的給定數值必須介於0到100之間。";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_BREAK = "脫離所包含的迴圈。";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_TOOLTIP_CONTINUE = "跳過剩下的迴圈，然後繼續下個迭帶運算。";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "警告： 此區塊僅可用於一個迴圈內。";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "每個清單中的項目，將項目的數值設定為變數 '%1'，然後執行其他宣告語句。";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Loops#count_with";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "從範圍 %1 到 %2 每隔 %3";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "使用";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "根據給定的變數%1，依照指定的間隔從頭到尾取每一個數值，然後執行指定的區塊。";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "在if區塊加入一個條件。";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "在if區塊中，加入一個最終會包含剩下情況的條件。";
Blockly.Msg.CONTROLS_IF_HELPURL = "http:\/\/code.google.com\/p\/blockly\/wiki\/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "利用增加、刪除或重新排列的方式重新配置if區塊。";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "否則";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "否則如果";
Blockly.Msg.CONTROLS_IF_MSG_IF = "如果";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "如果其值為真，則執行其宣告。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "如果其值為真，則執行第一個宣告區塊。反之，則執行第二個宣告區塊。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "如果第一個值為true，則執行第一個宣告區塊。此外，如果第二個值為true，則執行第二個宣告區塊。";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "如果第一個值為真，則執行第一個宣告區塊。此外，如果第二個值為真，則執行第二個宣告區塊。如果皆不為真，則執行最後的宣告區塊。";
...
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "將其宣告執行數次。";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "當值為false，則執行其宣告。";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "當值為true，則執行其宣告。";
...
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP = "回傳一個長度為零且無資料的串列";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "加入";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "利用增加、刪除或重新排列的方式重新配置清單區塊。";
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "使用這些值建立列表";
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "在清單中增加一個項目。";
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "增加一個有著任意數量項目的清單。";
Blockly.Msg.LISTS_GET_INDEX_FIRST = "第一";
Blockly.Msg.LISTS_GET_INDEX_FROM_END = "# 從結束";
Blockly.Msg.LISTS_GET_INDEX_FROM_START = "#";
Blockly.Msg.LISTS_GET_INDEX_GET = "獲取";
Blockly.Msg.LISTS_GET_INDEX_GET_REMOVE = "得到 去除";
Blockly.Msg.LISTS_GET_INDEX_LAST = "最後一個";
Blockly.Msg.LISTS_GET_INDEX_RANDOM = "隨機";
Blockly.Msg.LISTS_GET_INDEX_REMOVE = "去除";
