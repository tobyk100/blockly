...
Blockly.Msg.COLOUR_RANDOM_TOOLTIP = "Escolha uma cor ao acaso.";
...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Para cada item na lista, defina a variável '%1' para o item e então faça algumas instruções.";
...
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Acrescente, remova ou reordene seções para reconfigurar este bloco \"SE\".";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "senão";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "senão se";
Blockly.Msg.CONTROLS_IF_MSG_IF = "se";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Se um valor é verdadeiro, então faça algumas instruções.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Se um valor é verdadeiro, então faça o primeiro bloco de instruções.  Senão, faça o segundo bloco de instruções.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_3 = "Se o primeiro valor é verdadeiro, então faça o primeiro bloco de instruções.  Senão, se o segundo valor é verdadeiro, faça o segundo bloco de instruções.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_4 = "Se o primeiro valor é verdadeiro, então faça o primeiro bloco de instruções.  Senão, se o segundo valor é verdadeiro, faça o segundo bloco de instruções.  Se nenhum dos blocos for verdadeiro, faça o último bloco de instruções.";
...
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "Enquanto um valor for falso, faça algumas instruções.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "Enquanto um valor for verdadeiro, faça algumas instruções.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_END = "Remove o item na posição especificada de uma lista. #1 é o último item.";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_START = "Remove e retorna o item na posição especificada de uma lista.  #1 é o primeiro item.";
...
Blockly.Msg.LISTS_GET_SUBLIST_START_FROM_START = "obtem sublista começando pelo nº";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_START = "Define o item da posição especifica de uma lista.  #1 é o primeiro item.";
...
Blockly.Msg.LOGIC_TERNARY_TOOLTIP = "Avaliar a condição em \"teste\". Se a condição for verdadeira retorna o valor \"se verdadeiro\", caso contrário retorna o valor \"se falso\".";
...
Blockly.Msg.MATH_CONSTRAIN_TITLE = "restringir %1 inferior em %2 superior em %3";
Blockly.Msg.MATH_CONSTRAIN_TOOLTIP = "Restringir um número entre os limites especificados (inclusive).";
...
Blockly.Msg.MATH_IS_TOOLTIP = "Verificar se um número é par, impar, primo, inteiro, positivo, negativo, ou se é divisível por determinado número.  Retorna verdadeiro ou falso.";
...
Blockly.Msg.MATH_ONLIST_TOOLTIP_MEDIAN = "Retorna a mediana dos números em uma lista.";
...
Blockly.Msg.MATH_TRIG_TOOLTIP_COS = "Retorna o cosseno de um ângulo (não radiano).";
Blockly.Msg.MATH_TRIG_TOOLTIP_SIN = "Retorna o seno de um ângulo (não radiano).";
Blockly.Msg.MATH_TRIG_TOOLTIP_TAN = "Retorna a tangente de um ângulo (não radiano).";
...
Blockly.Msg.PROCEDURES_IFRETURN_TOOLTIP = "Se um valor é verdadeiro, então retorna um segundo valor.";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "em Caso de Título";
...
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "obter trecho a partir da primeira letra";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "obter trecho de letra nº a partir do final";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "obter trecho a partir da letra nº";
...
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST = "encontrar a última ocorrência de texto";
...
Blockly.Msg.VARIABLES_SET_TOOLTIP = "Define esta variável para ser igual ao valor informado.";
