...
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Para cada item em uma lista, definir a variável '%1' para o item e então fazer algumas declarações.";
...
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Acrescente uma alternativa final para o bloco \"SE\".";
...
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = "Cria uma função sem nenhum retorno.";
...
Blockly.Msg.PROCEDURES_HIGHLIGHT_DEF = "Destacar definição de função";
...
Blockly.Msg.TEXT_PROMPT_TOOLTIP_NUMBER = "Pedir algum texto ao usuário.";
Blockly.Msg.TEXT_PROMPT_TOOLTIP_TEXT = "Aviso para pedir ao usuário um texto.";
Blockly.Msg.TEXT_PROMPT_TYPE_NUMBER = "pedir um número com uma mensagem";
Blockly.Msg.TEXT_PROMPT_TYPE_TEXT = "pedir texto com uma mensagem";
...
Blockly.Msg.VARIABLES_GET_CREATE_SET = "Criar \"set %1'";
...
Blockly.Msg.VARIABLES_SET_CREATE_GET = "Criar 'get %1'";
