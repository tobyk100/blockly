...
Blockly.Msg.ADD_COMMENT = "Bæta við kommenti Bæta við athugasemd";
Blockly.Msg.CHANGE_VALUE_TITLE = "Breyta gildi:";
Blockly.Msg.COLLAPSE_ALL = "Fella saman blokkir";
Blockly.Msg.COLLAPSE_BLOCK = "Fella saman blokk";
...
Blockly.Msg.COLOUR_PICKER_TOOLTIP = "Veldu lit frá lita pallettunni.";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_BREAK = "brjótast út úr lykkju";
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "halda áfram með næstu ítrun lykkju";
...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_WARNING = "Varúð: Þessa einingu má aðeins nota innan lykkju.";
...
Blockly.Msg.CONTROLS_FOREACH_INPUT_ITEM = "fyrir hvern hlut";
Blockly.Msg.CONTROLS_FOREACH_TOOLTIP = "Setjir breytuna '%1' á hvern hlut í lista og búðu svo til nokkrar staðhæfingar.";
Blockly.Msg.CONTROLS_FOR_HELPURL = "https:\/\/code.google.com\/p\/blockly\/wiki\/Loops#count_with";
Blockly.Msg.CONTROLS_FOR_INPUT_FROM_TO_BY = "frá %1 til %2 af %3";
Blockly.Msg.CONTROLS_FOR_INPUT_WITH = "telja með";
Blockly.Msg.CONTROLS_FOR_TOOLTIP = "Have the variable %1 take on the values from the start number to the end number, counting by the specified interval, and do the specified blocks.";
Blockly.Msg.CONTROLS_IF_ELSEIF_TOOLTIP = "Bættu skilyrði við if eininguna.";
Blockly.Msg.CONTROLS_IF_ELSE_TOOLTIP = "Add a final, catch-all condition to the if block.";
Blockly.Msg.CONTROLS_IF_HELPURL = "http:\/\/code.google.com\/p\/blockly\/wiki\/If_Then";
Blockly.Msg.CONTROLS_IF_IF_TOOLTIP = "Bættu við, fjarlægðu eða raðaðu upp á nýtt til að lagfæra þessa if einingu.";
Blockly.Msg.CONTROLS_IF_MSG_ELSE = "else";
Blockly.Msg.CONTROLS_IF_MSG_ELSEIF = "else if";
Blockly.Msg.CONTROLS_IF_MSG_IF = "if";
Blockly.Msg.CONTROLS_IF_TOOLTIP_1 = "Ef gildið er rétt bættu þá við nokkrum staðhæfingum.";
Blockly.Msg.CONTROLS_IF_TOOLTIP_2 = "Ef (if) gildi er satt (true), framkvæmdu þá fyrstu eininguna. Annars, framkvæmdu seinni eininguna.";
...
Blockly.Msg.CONTROLS_REPEAT_TITLE = "endurtaktu %1 sinni";
Blockly.Msg.CONTROLS_REPEAT_TITLE_REPEAT = "endurtaktu";
Blockly.Msg.CONTROLS_REPEAT_TITLE_TIMES = "sinnum";
Blockly.Msg.CONTROLS_REPEAT_TOOLTIP = "Búðu til nokkrar staðhæfingar nokkrum sinnum.";
Blockly.Msg.CONTROLS_WHILEUNTIL_HELPURL = "http:\/\/code.google.com\/p\/blockly\/wiki\/Repeat";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = "endurtaktu þangað til";
Blockly.Msg.CONTROLS_WHILEUNTIL_OPERATOR_WHILE = "endurtaktu á meðan";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = "While a value is false, then do some statements.";
Blockly.Msg.CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = "While a value is true, then do some statements.";
Blockly.Msg.DELETE_BLOCK = "Eyða einingu";
Blockly.Msg.DELETE_X_BLOCKS = "Eyða %1 einingum";
Blockly.Msg.DISABLE_BLOCK = "Óvirkja einingu";
Blockly.Msg.DUPLICATE_BLOCK = "Tvöfaldaðu";
Blockly.Msg.ENABLE_BLOCK = "Virkja einingu";
Blockly.Msg.EXPAND_ALL = "Expand Blocks";
Blockly.Msg.EXPAND_BLOCK = "Expand Block";
Blockly.Msg.EXTERNAL_INPUTS = "Ytra inntak";
Blockly.Msg.HELP = "Hjálp";
Blockly.Msg.INLINE_INPUTS = "Inline Inputs";
Blockly.Msg.LISTS_CREATE_EMPTY_HELPURL = "http:\/\/en.wikipedia.org\/wiki\/Linked_list#Empty_lists";
Blockly.Msg.LISTS_CREATE_EMPTY_TITLE = "Skilgreindu tóman lista";
Blockly.Msg.LISTS_CREATE_EMPTY_TOOLTIP = "Skilar lista af lengdinni 0, án gagna færslna";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TITLE_ADD = "listi";
Blockly.Msg.LISTS_CREATE_WITH_CONTAINER_TOOLTIP = "Bættu við, fjarlægðu eða raðaðu upp á nýtt til að lagfæra þessa if einingu.";
Blockly.Msg.LISTS_CREATE_WITH_INPUT_WITH = "Skilgreindu lista með";
Blockly.Msg.LISTS_CREATE_WITH_ITEM_TOOLTIP = "Bættu við staki í listann.";
Blockly.Msg.LISTS_CREATE_WITH_TOOLTIP = "Skilgreindu lista með einhverjum fjölda af stökum.";
Blockly.Msg.LISTS_GET_INDEX_FIRST = "fyrsta";
Blockly.Msg.LISTS_GET_INDEX_FROM_END = "# frá enda";
Blockly.Msg.LISTS_GET_INDEX_FROM_START = "#";
Blockly.Msg.LISTS_GET_INDEX_GET = "sækja (get)";
Blockly.Msg.LISTS_GET_INDEX_GET_REMOVE = "sækja (get) og fjarlægja (remove)";
Blockly.Msg.LISTS_GET_INDEX_LAST = "síðasta";
Blockly.Msg.LISTS_GET_INDEX_RANDOM = "handahófskennt (random)";
Blockly.Msg.LISTS_GET_INDEX_REMOVE = "fjarlægja (e. remove)";
Blockly.Msg.LISTS_GET_INDEX_TAIL = "";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FIRST = "Skilar fyrsta staki í lista.";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_RANDOM = "Skilar handahófskenndu (e. random) staki í lista.";
