...
turtlepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = turtlepage.messages(null, null, opt_ijData) + turtlepage.startBlocks(null, null, opt_ijData) + '<script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'blockly_compressed.js"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'javascript_compressed.js"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'turtle/blocks.js"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'slider.js"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'turtle/answers.js"><\/script><table width="100%" ' + apps.menu({menu: opt_ijData.menu}, null, opt_ijData) + ' style="border-bottom: 1px solid #DBDBDB;"><tr><td><h1><span id="title"><a href="https://sites.google.com/site/computersciencefirst/">CS First</a> : ';
  switch (opt_ijData.page) {
    case 1:
      output += 'Turtle 1';
      break;
  ...
  output += '</span> &nbsp; ';
  for (var i721 = 1; i721 < 11; i721++) {
    output += ' ' + ((i721 == opt_ijData.level) ? (i721 > 9) ? '<span class="selected doubleDigit tab">' + soy.$$escapeHtml(i721) + '</span>' : '<span class="selected tab">' + soy.$$escapeHtml(i721) + '</span>' : (i721 < opt_ijData.level) ? '<a class="tab previous" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&page=' + soy.$$escapeHtml(opt_ijData.page) + '&level=' + soy.$$escapeHtml(i721) + '">' + soy.$$escapeHtml(i721) + '</a>' : '<a class="tab" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&page=' + soy.$$escapeHtml(opt_ijData.page) + '&level=' + soy.$$escapeHtml(i721) + '">' + soy.$$escapeHtml(i721) + '</a>');
  }
...
turtlepage.readonly = function(opt_data, opt_ignored, opt_ijData) {
  return turtlepage.messages(null, null, opt_ijData) + '<script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'blockly_compressed.js"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'turtle/blocks.js"><\/script><div id="blockly"></div>';
};
