...
turtlepage.startBlocks = function(opt_data, opt_ignored, opt_ijData) {
  ...
  if (opt_ijData.page == 1) {
    ...
    if (opt_ijData.level == 3 || opt_ijData.level == 5) {
      ...
      for (var i507 = 25; i507 < 61; i507 += 5) {
        output += '<block type="draw_move" ' + ((i507 == 25) ? 'x="300" y="100"' : '') + ' inline="false" editable="false" disabled="true"><title name="DIR">moveForward</title><value name="VALUE"><block type="math_number" disabled="true"><title name="NUM">' + soy.$$escapeHtml(i507) + '</title></block></value><next><block type="draw_turn" inline="false" editable="false" disabled="true"><title name="DIR">turnRight</title><value name="VALUE"><block type="math_number" disabled="true"><title name="NUM">90</title></block></value><next>';
      }
      for (var i515 = 5; i515 < 25; i515 += 5) {
...
turtlepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  output += '</span> &nbsp; ';
  for (var i711 = 1; i711 < 11; i711++) {
    output += ' ' + ((i711 == opt_ijData.level) ? (i711 > 9) ? '<span class="selected doubleDigit tab">' + soy.$$escapeHtml(i711) + '</span>' : '<span class="selected tab">' + soy.$$escapeHtml(i711) + '</span>' : (i711 < opt_ijData.level) ? '<a class="tab previous" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&page=' + soy.$$escapeHtml(opt_ijData.page) + '&level=' + soy.$$escapeHtml(i711) + '">' + soy.$$escapeHtml(i711) + '</a>' : '<a class="tab" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&page=' + soy.$$escapeHtml(opt_ijData.page) + '&level=' + soy.$$escapeHtml(i711) + '">' + soy.$$escapeHtml(i711) + '</a>');
  }
