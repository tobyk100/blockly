...
turtlepage.startBlocks = function(opt_data, opt_ignored, opt_ijData) {
  ...
  if (opt_ijData.page == 1) {
    switch (opt_ijData.level) {
      case 1:
      case 2:
        output += '<block type="draw_move_by_constant" x="20" y="20"></block>';
        break;
      case 3:
      case 4:
      case 5:
      case 6:
        ...
        break;
      case 7:
        output += '<block type="draw_turn_by_constant_restricted" x="20" y="20"><title name="DIR">turnRight</title><title name="VALUE">90</title></block>';
        break;
      case 8:
        output += '<block type="draw_colour" x="20" y="100"><value name="COLOUR"><block type="colour_random"></block></value><next><block type="draw_move_by_constant"><title name="DIR">moveForward</title><title name="VALUE">100</title><next><block type="draw_move_by_constant"><title name="DIR">moveBackward</title><title name="VALUE">100</title><next><block type="draw_turn_by_constant"><title name="DIR">turnRight</title><title name="VALUE">45</title></block></next></block></next></block></next></block>';
        break;
      case 9:
        ...
        break;
      case 10:
        output += '<block type="draw_move_by_constant" x="20" y="20"><title name="DIR">moveForward</title><title name="VALUE">100</title></block>';
        break;
    }
  } else if (opt_ijData.page == 2) {
...
<<<<<<< HEAD
  ...
  output += '</span> &nbsp; ';
  for (var i710 = 1; i710 < 11; i710++) {
    output += ' ' + ((i710 == opt_ijData.level) ? (i710 > 9) ? '<span class="selected doubleDigit tab">' + soy.$$escapeHtml(i710) + '</span>' : '<span class="selected tab">' + soy.$$escapeHtml(i710) + '</span>' : (i710 < opt_ijData.level) ? '<a class="tab previous" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&page=' + soy.$$escapeHtml(opt_ijData.page) + '&level=' + soy.$$escapeHtml(i710) + '">' + soy.$$escapeHtml(i710) + '</a>' : '<a class="tab" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&page=' + soy.$$escapeHtml(opt_ijData.page) + '&level=' + soy.$$escapeHtml(i710) + '">' + soy.$$escapeHtml(i710) + '</a>');
=======
  var output = turtlepage.messages(null, null, opt_ijData) + turtlepage.startBlocks(null, null, opt_ijData) + '<script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'blockly_compressed.js"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'javascript_compressed.js"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'turtle/blocks.js"><\/script>';
  if (opt_ijData.reinf) {
    output += turtlepage.showInterstitials(null, null, opt_ijData);
  } else {
    output += '<script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'slider.js"><\/script><script type="text/javascript" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'turtle/answers.js"><\/script><table ' + apps.menu({menu: opt_ijData.menu}, null, opt_ijData) + ' width="100%" style="padding-top: 1em;"><tr><td><h1><span id="title"><a href="https://sites.google.com/site/computersciencefirst/">CS First</a> : ';
    switch (opt_ijData.page) {
      case 1:
        output += 'Turtle 1';
        break;
    ...
    output += '</span> &nbsp; ';
    for (var i585 = 1; i585 < 11; i585++) {
      output += ' ' + ((i585 == opt_ijData.level) ? (i585 > 9) ? '<span class="selected doubleDigit tab">' + soy.$$escapeHtml(i585) + '</span>' : '<span class="selected tab">' + soy.$$escapeHtml(i585) + '</span>' : (i585 < opt_ijData.level) ? '<a class="tab previous" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&page=' + soy.$$escapeHtml(opt_ijData.page) + '&level=' + soy.$$escapeHtml(i585) + '">' + soy.$$escapeHtml(i585) + '</a>' : '<a class="tab" href="?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&page=' + soy.$$escapeHtml(opt_ijData.page) + '&level=' + soy.$$escapeHtml(i585) + '">' + soy.$$escapeHtml(i585) + '</a>');
    }
    output += '</h1></td><td class="farSide"></td></tr></table><div id="bubble"><div id="prompt">' + turtlepage.showInstructions(null, null, opt_ijData) + '</div></div><div id="blockCount"></div><div id="visualization"><canvas id="scratch" width="400" height="400" style="display: none"></canvas><canvas id="answer" width="400" height="400" style="display: none"></canvas><canvas id="images" width="400" height="400" style="display: none"></canvas><canvas id="display" width="400" height="400"></canvas></div><table style="padding-top: 1em;" width=400><tr><td style="width: 190px; text-align: center"><svg id="slider" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width="150" height="50"><!-- Slow icon. --><clipPath id="slowClipPath"><rect width=26 height=12 x=5 y=14 /></clipPath><image xlink:href="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'turtle/icons.png" height=42 width=84 x=-21 y=-10 clip-path="url(#slowClipPath)" /><!-- Fast icon. --><clipPath id="fastClipPath"><rect width=26 height=16 x=120 y=10 /></clipPath><image xlink:href="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'turtle/icons.png" height=42 width=84 x=120 y=-11 clip-path="url(#fastClipPath)" /></svg></td><td style="width: 15px;"><img id="spinner" style="visibility: hidden;" src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'turtle/loading.gif" height=15 width=15></td><td style="width: 190px; text-align: center"><button id="runButton" class="launch" onclick="Turtle.runButtonClick();"><img src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'media/1x1.gif" class="run icon21">Run</button><button id="resetButton" class="launch" onclick="BlocklyApps.resetButtonClick();" style="display: none"><img src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'media/1x1.gif" class="stop icon21">Reset</button></td></tr></table><div id="toolbarDiv"><button title="See generated JavaScript code." onclick="BlocklyApps.showCode(this);"><img src=\'' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'media/1x1.gif\' class="code icon21"></button><button id="linkButton" title="See generated JavaScript code." onclick="BlocklyStorage.link();"><img src=\'' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'media/1x1.gif\' class="link icon21"></button></div>' + turtlepage.toolbox(null, null, opt_ijData) + '<div id="blockly"></div>';
>>>>>>> Added absolute urls to turtle.
  }
