...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  var iLimit268 = opt_ijData.mode == 2 ? 19 : 11;
  ...
  output += '</h1></td><td class="farSide">&nbsp;&nbsp;<button id="helpButton" onclick="BlocklyApps.showHelp(true, ' + soy.$$escapeHtml(opt_ijData.level) + ', false);">Help</button>&nbsp;&nbsp;<button id="pegmanButton" onmousedown="Maze.showPegmanMenu();"><img src="../media/1x1.gif"><span>&#x25BE;</span></button></td></tr></table>' + apps.dialog(null, null, opt_ijData) + apps.codeDialog(null, null, opt_ijData) + apps.storageDialog(null, null, opt_ijData) + '<div id="help" class="dialogHiddenContent"><div style="padding-bottom: 0.7ex;"><br><img class="stars feedback" id="star1" src="../star1.png"><img class="stars feedback" id="star2" src="../star2.png"><img class="stars feedback" id="star3" src="../star3.png"><ul id="levelFeedbackText"><<<<<<< HEAD<span id="hintTitle" class="feedback" style="display: none; margin-left: -30px">fooHints:</span>=======<span id="hintTitle" class="feedback" style="display: none; margin-left: -30px">Hint:</span>>>>>>>> codedotorg/mooc<li id="nextLevelMsg" style="display: none; margin-left: -40px;">Congratulations! You have completed this level.</li><li id="finalLevelMsg" style="display: none; margin-left: -40px;">Congratulations! You have solved the final level.</li><li id="emptyBlocksError" class="feedback" style="display: none">Remove empty blocks.</li><li id="missingBlocksError" class="feedback" style="display: none"><<<<<<< HEADTry oneo r more of the blocks below to solve this level.</li>=======Try one or more of the blocks below to solve this level.</li>>>>>>>> codedotorg/mooc<li id="tooManyBlocksError" class="feedback" style="display: none">This level can be solved with <span id="idealNumberMessage"></span> blocks.</li><li id="tooFewBlocksError" class="feedback" style="display: none">You are using all of the necessary types of blocks, but try using more  of these types of blocks to complete this level.</li><li id="levelIncompleteError" class="feedback" style="display: none"><<<<<<< HEADYou are using all of the necessary types of blocks but not in the right way.</li>=======You are using all of the necessary types of blocks but not in the right way.</li>>>>>>>> codedotorg/mooc</ul><iframe id="feedbackBlocks" class="feedback" style="margin-left: 50px; height: 80px; width: 500px; border: none; display: none;" src=""></iframe><div id="interstitial" style="display: none;"><div style="margin-left: 50px;"><div id="reinfbubble"><span id="reinfMsg">';
