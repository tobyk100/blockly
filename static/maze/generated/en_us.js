...
mazepage.messages = function(opt_data, opt_ignored, opt_ijData) {
  return '<div style="display: none"><span id="moveForward">move forward</span><span id="turnLeft">turn left</span><span id="turnRight">turn right</span><span id="doCode">do</span><span id="elseCode">else</span><span id="pathAhead">if path ahead</span><span id="pathLeft">if path to the left</span><span id="pathRight">if path to the right</span><span id="repeatUntil">repeat until</span><span id="moveForwardTooltip">Move me forward one space.</span><span id="q2wrong">No - Try tracking my direction while following the program.</span><span id="q2right">That\'s right! Good job.</span><span id="q5wrong">No - Try tracking my direction while following the program.</span><span id="q5right">That\'s right! Good job.</span><span id="q9wrong">No - Try tracking my direction while following the program.</span><span id="q9right">That\'s right! Good job.</span><span id="turnTooltip">Turns me left or right by 90 degrees.</span><span id="ifTooltip">If there is a path in the specified direction, then do some actions.</span><span id="ifelseTooltip">If there is a path in the specified direction, then do the first block of actions. Otherwise, do the second block of actions.</span><span id="whileTooltip">Repeat the enclosed actions until finish point is reached.</span><span id="capacity0">You have<span id=\'capacityNumber\'>0</span> blocks left.</span><span id="capacity1">You have <span id=\'capacityNumber\'>1</span> block left.</span><span id="capacity2">You have <span id=\'capacityNumber\'>%1</span> blocks left.</span><span id="nextLevel">Congratulations! You have completed this level.</span><span id="finalLevel">Congratulations! You have solved the final level.</span><span id="oneTopBlock">On this level, you need to stack together all of the blocks in the white workspace.</span><span id="numBlocksNeeded">This level can be solved with %1 blocks.</span></div>';
};


mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  var output = ((opt_ijData.mode == 2) ? '<script type="text/javascript" src="adp_maze.js"><\/script>' : '') + mazepage.messages(null, null, opt_ijData) + '<table width="100%" ' + apps.menu({menu: opt_ijData.menu}, null, opt_ijData) + ' style="border-bottom: 1px solid #DBDBDB;"><tr><td><h1><span id="title"><a href="https://sites.google.com/site/computersciencefirst/">CS First</a> : Maze</span> &nbsp; ';
  var iLimit227 = opt_ijData.mode == 2 ? 19 : 11;
  for (var i227 = 1; i227 < iLimit227; i227++) {
  ...
  output += '</ul><div id="interstitial" style="display: none;"><div style="margin-left: 50px;"><div id="reinfbubble"><span id="reinfMsg">';
  switch (opt_ijData.level) {
    case 1:
  ...
  switch (opt_ijData.level) {
    case 1:
      ...
      break;
    case 2:
      output += '<p class="postInter" style="border: 2px solid black; width: 470px; margin-left: 20px;"><img src="dirs.png" style="margin-left: 30px; padding-bottom: 4px;"><img src="dirs2.png"><iframe style="height: 133px; width: 170px; border: none;" src="readonly.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&xml=%3Cblock%20type%3D%22maze_turn%22%20x%3D%2226%22%20y%3D%2222%22%3E%3Ctitle%20name%3D%22DIR%22%3EturnLeft%3C%2Ftitle%3E%3Cnext%3E%3Cblock%20type%3D%22maze_turn%22%3E%3Ctitle%20name%3D%22DIR%22%3EturnLeft%3C%2Ftitle%3E%3Cnext%3E%3Cblock%20type%3D%22maze_turn%22%3E%3Ctitle%20name%3D%22DIR%22%3EturnRight%3C%2Ftitle%3E%3Cnext%3E%3Cblock%20type%3D%22maze_turn%22%3E%3Ctitle%20name%3D%22DIR%22%3EturnLeft%3C%2Ftitle%3E%3C%2Fblock%3E%3C%2Fnext%3E%3C%2Fblock%3E%3C%2Fnext%3E%3C%2Fblock%3E%3C%2Fnext%3E%3C%2Fblock%3E"></iframe></p>';
      break;
    case 3:
      output += '<p class="preInter"><iframe style="height: 110px; width: 180px; border: none; margin-left: 110px;" src="readonly.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&xml=%3Cblock%20type%3D%22maze_forever%22%20x%3D%2220%22%20y%3D%2222%22%3E%3Cstatement%20name%3D%22DO%22%3E%3Cblock%20type%3D%22maze_moveForward%22%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3C%2Fblock%3E""></iframe><br><iframe class="video" src=""></iframe></p>';
      break;
    case 5:
      output += '<p class="preInter"><iframe style="height: 110px; width: 180px; border: none; margin-left: 60px;" src="readonly.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&xml=%3Cblock%20type%3D%22maze_if%22%20x%3D%2215%22%20y%3D%2214%22%3E%3Ctitle%20name%3D%22DIR%22%3EisPathLeft%3C%2Ftitle%3E%3Cstatement%20name%3D%22DO%22%3E%3Cblock%20type%3D%22maze_turn%22%3E%3Ctitle%20name%3D%22DIR%22%3EturnLeft%3C%2Ftitle%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3C%2Fblock%3E"></iframe><br><iframe class="video" src=""></iframe></p><p class="postInter" style="border: 2px solid black; width: 530px; margin-left: 30px;"><img style="margin-top: 10px; margin-left: 20px;" src="repeat_block2.png"><iframe style="height: 180px; width: 230px; border: none; margin-left: 60px;" src="readonly.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&xml=%3Cblock%20type%3D%22maze_forever%22%20x%3D%2210%22%20y%3D%2212%22%3E%3Cstatement%20name%3D%22DO%22%3E%3Cblock%20type%3D%22maze_if%22%3E%3Ctitle%20name%3D%22DIR%22%3EisPathRight%3C%2Ftitle%3E%3Cstatement%20name%3D%22DO%22%3E%3Cblock%20type%3D%22maze_turn%22%3E%3Ctitle%20name%3D%22DIR%22%3EturnRight%3C%2Ftitle%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3Cnext%3E%3Cblock%20type%3D%22maze_moveForward%22%3E%3C%2Fblock%3E%3C%2Fnext%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3C%2Fblock%3E"></iframe><br></p>';
      break;
    case 9:
      output += '<p class="preInter"><iframe style="height: 133px; width: 170px; border: none; margin-left: 60px;" src="readonly.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&xml=%3Cblock%20type%3D%22maze_ifElse%22%20x%3D%226%22%20y%3D%2216%22%3E%3Ctitle%20name%3D%22DIR%22%3EisPathForward%3C%2Ftitle%3E%3Cstatement%20name%3D%22DO%22%3E%3Cblock%20type%3D%22maze_moveForward%22%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3Cstatement%20name%3D%22ELSE%22%3E%3Cblock%20type%3D%22maze_turn%22%3E%3Ctitle%20name%3D%22DIR%22%3EturnLeft%3C%2Ftitle%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3C%2Fblock%3E"></iframe></p><p class="postInter"><img style="margin-left: 40px; height: 300px;" src="ifelse.png"><iframe style="height: 300px; width: 290px; border: none;" src="readonly.html?lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&xml=%3Cblock%20type%3D%22maze_ifElse%22%20x%3D%2222%22%20y%3D%2221%22%3E%3Ctitle%20name%3D%22DIR%22%3EisPathForward%3C%2Ftitle%3E%3Cstatement%20name%3D%22DO%22%3E%3Cblock%20type%3D%22maze_moveForward%22%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3Cstatement%20name%3D%22ELSE%22%3E%3Cblock%20type%3D%22maze_ifElse%22%3E%3Ctitle%20name%3D%22DIR%22%3EisPathLeft%3C%2Ftitle%3E%3Cstatement%20name%3D%22DO%22%3E%3Cblock%20type%3D%22maze_turn%22%3E%3Ctitle%20name%3D%22DIR%22%3EturnLeft%3C%2Ftitle%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3Cstatement%20name%3D%22ELSE%22%3E%3Cblock%20type%3D%22maze_if%22%3E%3Ctitle%20name%3D%22DIR%22%3EisPathRight%3C%2Ftitle%3E%3Cstatement%20name%3D%22DO%22%3E%3Cblock%20type%3D%22maze_turn%22%3E%3Ctitle%20name%3D%22DIR%22%3EturnRight%3C%2Ftitle%3E%3Cnext%3E%3Cblock%20type%3D%22maze_moveForward%22%3E%3C%2Fblock%3E%3C%2Fnext%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3C%2Fblock%3E%3C%2Fstatement%3E%3C%2Fblock%3E"></iframe></p>';
      break;
  }
  switch (opt_ijData.level) {
    case 2:
      output += '<p class="quiz postInter"><input type="radio" name="q2" id="q21" onclick="BlocklyApps.showReinfHelp(' + soy.$$escapeHtml(opt_ijData.level) + ', \'q2w\')"><label for="q21" style="font-weight: bold">N</label><br><input type="radio" name="q2" id="q22" onclick="BlocklyApps.showReinfHelp(' + soy.$$escapeHtml(opt_ijData.level) + ', \'q2w\')"><label for="q22" style="font-weight: bold">E</label><br><input type="radio" name="q2" id="q23" onclick="BlocklyApps.showReinfHelp(' + soy.$$escapeHtml(opt_ijData.level) + ', \'q2w\')"><label for="q23" style="font-weight: bold">S</label><br><input type="radio" name="q2" id="q24" onclick="BlocklyApps.showReinfHelp(' + soy.$$escapeHtml(opt_ijData.level) + ', \'q2r\')"><label for="q24" style="font-weight: bold">W</label><br></p>';
      break;
    case 5:
      output += '<p class="quiz postInter" style="margin-left: 115px; margin-bottom: 20px;"><img style="margin-left: 50px;" src="repeat_blocka1.png" onclick="BlocklyApps.showReinfHelp(' + soy.$$escapeHtml(opt_ijData.level) + ', \'q5w\')"><img style="margin-left: 50px;" src="repeat_blocka2.png" onclick="BlocklyApps.showReinfHelp(' + soy.$$escapeHtml(opt_ijData.level) + ', \'q5r\')"><img style="margin-left: 50px;" src="repeat_blocka3.png" onclick="BlocklyApps.showReinfHelp(' + soy.$$escapeHtml(opt_ijData.level) + ', \'q5w\')"></p>';
      break;
    case 9:
      output += '<p class="quiz postInter"><input type="radio" name="q9" id="q91" onClick="BlocklyApps.showReinfHelp(' + soy.$$escapeHtml(opt_ijData.level) + ', \'q9r\')"><label for="q91" style="font-weight: bold">Yes</label><br><input type="radio" name="q9" id="q92" onClick="BlocklyApps.showReinfHelp(' + soy.$$escapeHtml(opt_ijData.level) + ', \'q9w\')"><label for="q92" style="font-weight: bold">No</p>';
      break;
  }
  output += '<div id="reinfQuizFeedback" style="display:none;"><div style="padding-bottom: 0.7ex; text-align:center;"><textarea id="reinfFeedbackText" rows=2 cols=40 style="resize: none; border: none; text-align: center; overflow: hidden; font-size: 16pt; font-family: Arial;"></textarea></div></div></div><br><div id="returnToLevelButton" style="display:none;">' + apps.ok(null, null, opt_ijData) + '</div><div style="text-align: center"><button id="tryAgainButton" class="launch" style="display: none" onclick="BlocklyApps.goToNextLevelOrReset(false, ' + soy.$$escapeHtml(opt_ijData.level) + ', ' + soy.$$escapeHtml(opt_ijData.skin) + ');">Try again</button><button id="continueButton" class="launch" style="display: none" onclick="BlocklyApps.goToNextLevelOrReset(true, ' + soy.$$escapeHtml(opt_ijData.level) + ', ' + soy.$$escapeHtml(opt_ijData.skin) + ');">Continue</button></div></div></div></div><div id="visualization"><div id="hintBubble"><div id="hint">';
  if (opt_ijData.mode == 1) {
    switch (opt_ijData.level) {
      case 1:
