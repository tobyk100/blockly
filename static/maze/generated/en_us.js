...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  output += '</span></div><img id="pegman_bubble" height=42 width=55 src="pegman_bubble.png"></div><img id="pegman_bubble" height=42 width=55 src="' + soy.$$escapeHtml(opt_ijData.baseUrl) + 'maze/pegman_bubble.png">';
  if (opt_ijData.mode == 1) {
    switch (opt_ijData.level) {
      case 1:
