...
if (typeof karelpage == 'undefined') { var karelpage = {}; }


karelpage.messages = function(opt_data, opt_ignored, opt_ijData) {
...
karelpage.readonly = function(opt_data, opt_ignored, opt_ijData) {
  return karelpage.messages(null, null, opt_ijData) + '<script type="text/javascript" src="../blockly_compressed.js"><\/script><script type="text/javascript" src="../' + soy.$$escapeHtml(opt_ijData.langSrc) + '"><\/script><script type="text/javascript" src="blocks.js"><\/script><div id="blockly"></div>';
};


karelpage.startBlocks = function(opt_data, opt_ignored, opt_ijData) {
  var output = '';
  if (opt_ijData.page == 1) {
    ...
    switch (opt_ijData.level) {
      case 2:
        output += karelpage.fillShovelfuls({shovelfuls: 5}, null, opt_ijData);
        break;
      case 3:
        output += karelpage.fillShovelfuls({shovelfuls: 5}, null, opt_ijData);
        break;
      case 4:
        output += karelpage.fillShovelfuls({shovelfuls: 5}, null, opt_ijData) + '<block type="procedures_defnoreturn" x="300" y="200" editable=false deletable=false><mutation></mutation><title name="NAME">remove 7</title></block>';
        break;
      case 5:
        ...
        break;
      case 6:
        output += karelpage.fillShovelfuls({shovelfuls: 8}, null, opt_ijData) + karelpage.removeShovelfuls({shovelfuls: 8}, null, opt_ijData);
        break;
      case 7:
...
karelpage.fillShovelfuls = function(opt_data, opt_ignored, opt_ijData) {
...
karelpage.removeShovelfuls = function(opt_data, opt_ignored, opt_ijData) {
...
karelpage.controlsFor = function(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
