...
mazepage.start = function(opt_data, opt_ignored, opt_ijData) {
  ...
  var iLimit295 = opt_ijData.maxLevel + 1;
  for (var i295 = 1; i295 < iLimit295; i295++) {
    output += ' ' + ((i295 == opt_ijData.level) ? (i295 > 9) ? '<span class="selected doubleDigit tab">' + soy.$$escapeHtml(i295) + '</span>' : '<span class="selected singleDigit tab">' + soy.$$escapeHtml(i295) + '</span>' : (i295 < opt_ijData.level) ? '<a class="tab previous" href="?page=' + soy.$$escapeHtml(opt_ijData.page) + '&lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i295) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i295) + '</a>' : '<a class="tab" href="?page=' + soy.$$escapeHtml(opt_ijData.page) + '&lang=' + soy.$$escapeHtml(opt_ijData.lang) + '&level=' + soy.$$escapeHtml(i295) + '&skin=' + soy.$$escapeHtml(opt_ijData.skin) + '">' + soy.$$escapeHtml(i295) + '</a>');
  }
  ...
  if (opt_ijData.page == 1) {
    ...
    switch (opt_ijData.level) {
      case 1:
        ...
        break;
      case 2:
        output += 'Can you find a solution using 2 blocks? Try using the given function(s).';
        break;
      case 3:
        output += 'Can you find a solution using 3 blocks? Try using the given function(s) inside a while block.';
        break;
      case 4:
      ...
      case 5:
        ...
        break;
      case 6:
        output += 'Can you find a solution using 4 blocks? Try using the given function(s).';
        break;
      case 7:
        output += 'Can you find a solution by adding 8 blocks in the "avoid the cow and remove 1" block?';
        break;
      case 8:
        output += 'Can you find a solution using 2 blocks? Try using the given function(s) inside one of the loop blocks.';
        break;
      case 9:
        output += 'Can you find a solution using 4 blocks? Try including an if block.';
        break;
